...
// ── app/globals.css ──
write('app/globals.css', `@import url('https://fonts.googleapis.com/css2?family=Syne:wght@400;500;600;700;800&family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;0,9..40,600;1,9..40,400&family=JetBrains+Mono:wght@400;500&display=swap');
...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-center px-6">
      ...
      <p className="text-muted mb-8">This course does not exist yet — but it might soon.</p>
...
// ── lib/courses.ts ──
write('lib/courses.ts', `export type Lesson  = { id:string; title:string; duration:string; free?:boolean };
...
write('components/CourseCard.tsx', `import Link from "next/link";
      ...
      <div className="course-card rounded-2xl border border-border bg-card p-6 flex flex-col gap-4 h-full cursor-pointer">
        ...
        <div className="mt-auto pt-4 border-t border-border flex items-center justify-between">
          <div className="flex items-center gap-3 text-xs text-muted">
            {!course.comingSoon && (<><span className="text-yellow-400">★</span><strong className="text-white">{course.rating}</strong><span>· {course.lessons} lessons · {course.duration}</span></>)}
          </div>
...
// ── app/page.tsx ──
write('app/page.tsx', `import { courses } from "@/lib/courses";
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <div className="fade-up fade-up-delay-4 flex items-center justify-center gap-4 mb-16">
            ...
            <button className="text-muted hover:text-white transition-colors text-sm font-medium px-4 py-3.5">See learning paths →</button>
          </div>
...
// ── app/about/page.tsx ──
write('app/about/page.tsx', `import type { Metadata } from "next";
    ...
    <div className="min-h-screen pt-24 pb-32 px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="inline-flex items-center gap-4 bg-card border border-border rounded-2xl px-6 py-4 hover:border-accent transition-colors">
          <div className="w-10 h-10 rounded-xl bg-card flex items-center justify-center text-lg border border-border">✉️</div>
...
write('app/courses/[slug]/page.tsx', `import { getCourse, courses } from "@/lib/courses";
